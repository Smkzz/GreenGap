...
from .util import MAX_CONFIG_BYTES, MAX_RUNTIME_EXPECTED_IDENTITIES, read_limited_text
...
def _normalize_payload(payload: Any) -> ExplicitWitnessConfig:
    ...
    return ExplicitWitnessConfig(collection, execution)
